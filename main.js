...
/* harmony import */ var _tasksDOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tasksDOM */ "./src/tasksDOM.js");
...
/* harmony default export */ __webpack_exports__["default"] = (varList);
...
function closeProjectsBoard(event) {
  ...
  if (
    ...
    _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].closeProjectsBoard();
  }
}

function displayOrCloseProjectsBoard() {
  // eslint-disable-next-line no-shadow
  const { closeProjectsBoard, openProjectsBoard } = _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"];
...
varList.projectsList.addEventListener('click', _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].projectsListEvents);
...
varList.projectInputForm.addEventListener('submit', (event) => {
  ...
  _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].addNewProjectToProjectsList(projectInputVal);
  displayDeleteProjectIcon();
  hideDeleteProjectIcon();
});

varList.projectSubmitIcon.addEventListener('click', () => {
  _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].addNewProjectToProjectsList();
  displayDeleteProjectIcon();
  hideDeleteProjectIcon();
});
...
function displayTaskDetails(event) {
  ...
  for (let i = 0; i <= tasks.length - 1; i += 1) {
    if ((event.target === tasks[i]
      ...
      _tasksDOM__WEBPACK_IMPORTED_MODULE_2__["default"].displayTaskProperties(clickedTask);
...
varList.tasksBoard.addEventListener('click', (event) => {
  ...
  } = _tasksDOM__WEBPACK_IMPORTED_MODULE_2__["default"];
  ...
  if (Array.from(varList.tasksList.children).length > 0) {
    ...
    for (let i = 0; i < taskUncheckedIcon.length; i += 1) {
      if (event.target === taskUncheckedIcon[i]
        ...
        _tasks__WEBPACK_IMPORTED_MODULE_4__["default"].checkOrUncheck(event.target.parentElement.getAttribute('data-task'),
...
varList.taskProperties.addEventListener('click', _tasksDOM__WEBPACK_IMPORTED_MODULE_2__["default"].closeAddTaskPropertiesMenuOnBgClick);

function restoreSavedProjectsData() {
  const storedProjects = JSON.parse(_storage__WEBPACK_IMPORTED_MODULE_3__["projectsFromLS"].accessData());
  if (storedProjects) {
    for (let i = 3; i < storedProjects.length; i += 1) {
      _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].addNewProjectToProjectsList(storedProjects[i]);
      displayDeleteProjectIcon();
      hideDeleteProjectIcon();
      varList.projectsList.addEventListener(
        'click',
        _projectsDOM__WEBPACK_IMPORTED_MODULE_1__["default"].projectsListEvents,
      );
    }
  }
}
...
function restoreSavedTasksData() {
  const storedTasks = JSON.parse(_storage__WEBPACK_IMPORTED_MODULE_3__["tasksFromLS"].accessData());
  _storage__WEBPACK_IMPORTED_MODULE_3__["tasksFromLS"].removeData();
  if (storedTasks) {
    storedTasks.forEach((task) => {
      ...
      _tasksDOM__WEBPACK_IMPORTED_MODULE_2__["default"].addNewTaskToTasksList(
        task.taskTitle,
        projectVal,
        task.priority,
        task.dueDate,
...
window.onload = () => {
  ...
  varList.dueDate.min = `${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(new Date(), 'yyyy-MM-dd')}`;
  varList.updateDate.min = `${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["format"])(new Date(), 'yyyy-MM-dd')}`;
...
const projectManager = (() => {
  function addProject() {
    const savedProjectsArr = _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedProjectsArr();
    _storage__WEBPACK_IMPORTED_MODULE_1__["projectsFromLS"].updateData(savedProjectsArr);
  }
  ...
  function removeProject() {
    ...
    if (savedProjectsArr.length > 3) {
      ...
      _storage__WEBPACK_IMPORTED_MODULE_1__["projectsFromLS"].removeData(savedProjectsArr);
    }
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ "./src/index.js");
/* harmony import */ var _tasksDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tasksDOM */ "./src/tasksDOM.js");
...
const projectBoardHandlers = (() => {
  function openProjectsBoard() {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectsBoard.classList.toggle('displayProjects');
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].mainContent.style.gridTemplateAreas = '"pb tb"';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectsBoard.style.gridArea = 'pb';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].mainContent.style.gridTemplateColumns = '1fr 2fr';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasksBoard.style.width = '65vw';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasksList.style.width = 'inherit';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasksBoard.style.opacity = '0.5';
  }

  function closeProjectsBoard() {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectsBoard.classList.toggle('displayProjects');
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].mainContent.style.gridTemplateAreas = '"tb"';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].mainContent.style.gridTemplateColumns = '1fr';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].mainContent.style.removeProperty('grid-gap');
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasksBoard.style.width = '100vw';
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasksBoard.style.removeProperty('opacity');
  }

  // eslint-disable-next-line consistent-return
  function activeProject() {
    const updatedProjects = _index__WEBPACK_IMPORTED_MODULE_0__["default"].projects();
  ...
  function addNewProjectToProjectsList(project) {
    if (project.length > 0
      ...
      _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList.appendChild(newProject);
      _projects__WEBPACK_IMPORTED_MODULE_2__["default"].addProject();
      _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectInputForm.reset();
    }
  }
  ...
  function checkDuplicateProjects() {
    ...
    === _index__WEBPACK_IMPORTED_MODULE_0__["default"].projectInput.value.toLowerCase()));
  }

  function projectsListEvents(event) {
    const { target } = event;
    const deleteProjectFromProjectsList = (() => {
      const deleteProjectIcons = _index__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProjectIcons();
      const updatedTasks = _index__WEBPACK_IMPORTED_MODULE_0__["default"].tasks();
      const updatedProjects = _index__WEBPACK_IMPORTED_MODULE_0__["default"].projects();
      for (let i = 0; i < deleteProjectIcons.length; i += 1) {
        if (target === deleteProjectIcons[i]) {
          ...
          _tasks__WEBPACK_IMPORTED_MODULE_3__["default"].removeTasksBasedOnProjectName(target.parentElement.getAttribute('data-project'));
          target.parentElement.style.display = 'none';
          target.parentElement.remove();
          _projects__WEBPACK_IMPORTED_MODULE_2__["default"].removeProject();
        }
      }
      event.stopPropagation();
    })();
    ...
    const makeProjectActive = (() => {
      ...
      for (let i = 0; i < updatedProjects.length; i += 1) {
        if (updatedProjects[i] === target) {
          ...
          _tasksDOM__WEBPACK_IMPORTED_MODULE_1__["default"].displayActiveProjectTasks();
          return;
        }
      }
    })();
...
/* harmony default export */ __webpack_exports__["default"] = (projectBoardHandlers);
...
/*!************************!*\
  !*** ./src/storage.js ***!
  \************************/
/*! exports provided: tasksFromLS, projectsFromLS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tasksFromLS", function() { return tasksFromLS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "projectsFromLS", function() { return projectsFromLS; });
class DataStore {
    constructor(itemRef) {
...
const tasksFromLS = new DataStore("savedTasksArr");

const projectsFromLS = new DataStore("savedProjectsArr");
...
const taskManager = (() => {
  function savedTasksArr() {
    const storedTasks = JSON.parse(_storage__WEBPACK_IMPORTED_MODULE_1__["tasksFromLS"].accessData('savedTasksArr'));
    if (storedTasks) {
      _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = [...storedTasks];
      return _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr;
    }
    return [];
  }

  function addTask(taskTitle, project, priority, dueDate, desc, checked) {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = savedTasksArr();
    if (!duplicateTasks(taskTitle, project)) {
      ...
      _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.push(newTask);
      _storage__WEBPACK_IMPORTED_MODULE_1__["tasksFromLS"].updateData(_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr);
    }
  }

  function duplicateTasks(title, project) {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = savedTasksArr();
    if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length > 0) {
      _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.some((task) => task.taskTitle === title
  ...
  function checkOrUncheck(task, project, checkVal) {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = savedTasksArr();
    for (let i = 0; i < _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length; i += 1) {
      if (task === _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].taskTitle
                && ((project === '' && _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].projectsRelated.length === 1)
                || (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].projectsRelated.includes(project)))) {
        _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].checked = checkVal;
        _storage__WEBPACK_IMPORTED_MODULE_1__["tasksFromLS"].updateData(_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr);
      }
    }
  }
  ...
  function removeTask(taskName, projectName) {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = savedTasksArr();
    for (let i = 0; i < _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length; i += 1) {
      if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].taskTitle === taskName
                && (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].projectsRelated.includes(projectName.toLowerCase())
                || _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].projectsRelated.length === 1)) {
        _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.splice(i, 1);
        break;
      }
    }
    if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length > 0) {
      ...
      _storage__WEBPACK_IMPORTED_MODULE_1__["tasksFromLS"].removeData(_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr);
    }
  }
  ...
  function removeTasksBasedOnProjectName(projectName) {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr = savedTasksArr();
    if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length > 0) {
      const duplicateSavedTasksArr = [..._index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr];
      for (let i = 0; i < duplicateSavedTasksArr.length; i += 1) {
        if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr[i].projectsRelated.includes(projectName.toLowerCase())) {
          _index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.splice(i, 1);
        }
      }
      if (_index__WEBPACK_IMPORTED_MODULE_0__["default"].savedTasksArr.length > 0) {
...
const tasksBoardHandlers = (() => {
  function displayActiveProjectTasks() {
    const updatedTasks = _index__WEBPACK_IMPORTED_MODULE_1__["default"].tasks();
    const { activeProject } = _projectsDOM__WEBPACK_IMPORTED_MODULE_2__["default"];
  ...
  function openAddTaskPropertiesMenu() {
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display = 'block';
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.zIndex = '10';
  ...
  function closeAddTaskPropertiesMenuOnBgClick(event) {
    ...
    if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display === 'block'
            && (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.style.display === 'grid'
             || window.getComputedStyle(_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm).display === 'grid')
            && event.target === _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties
            && event.target !== _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm
            && !(Array.from(_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.children).includes(event.target))) {
  ...
  function addNewTaskToTasksList(taskTitle, projectVal, priority, dueDate, desc, checked) {
    if (taskTitle.length > 0
      ...
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].tasksList.appendChild(newTask);
      ...
      if (dueDate !== '') {
        timeLeft[timeLeft.length - 1].innerHTML = `${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["formatDistanceToNowStrict"])(new Date(dueDate),
          { addSuffix: true })}`;
      } else {
      ...
      _tasks__WEBPACK_IMPORTED_MODULE_3__["default"].addTask(taskTitle, projectVal, priority,
        dueDate, desc, checked);
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.reset();
      event.stopPropagation();
    }
  }
  ...
  function closeAddTaskPropertiesMenu() {
    addNewTaskToTasksList(
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskTitle.value,
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].projectSelect.value,
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].priority.value,
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].dueDate.value,
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].desc.value,
      false,
    );
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display = 'none';
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].navContainer.style.removeProperty('opacity');
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].tasksBoard.style.removeProperty('opacity');
  }
  ...
  function updateProjectSelectOptions() {
    ...
    const updatedProjects = _index__WEBPACK_IMPORTED_MODULE_1__["default"].projects();
    for (let i = 3; i < updatedProjects.length; i += 1) {
      const newOption = document.createElement('option');
      newOption.innerText = updatedProjects[i].innerText;
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].projectSelect.appendChild(newOption);
    }
  }
  ...
  function removeTaskFromTasksList(event) {
    _tasks__WEBPACK_IMPORTED_MODULE_3__["default"].removeTask(event.target.parentElement.getAttribute('data-task'),
  ...
  function displayTaskProperties(clickedTask) {
    if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display !== 'block') {
      ...
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.style.display = 'none';
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskUpdateForm.style.display = 'grid';
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr = _tasks__WEBPACK_IMPORTED_MODULE_3__["default"].savedTasksArr();
      for (let i = 0; i <= _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr.length - 1; i += 1) {
        if (clickedTask.getAttribute('data-task')
                === _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].taskTitle.toLowerCase()
                    && (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.includes(clickedTask.getAttribute('data-project'))
                || _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.length === 1)) {
          document.querySelector('#task-name').innerText = `${_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].taskTitle}`;
          if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.length !== 1) {
          ...
          if (clickedTask.classList.contains('high-priority')) {
            _index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.value = Array.from(_index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.children)[0].innerText;
          } else if (clickedTask.classList.contains('medium-priority')) {
            _index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.value = Array.from(_index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.children)[1].innerText;
          } else {
            _index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.value = Array.from(_index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.children)[2].innerText;
          }
          _index__WEBPACK_IMPORTED_MODULE_1__["default"].updateDate.value = _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].dueDate;
          _index__WEBPACK_IMPORTED_MODULE_1__["default"].updateDesc.value = _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].desc;
          break;
        }
        event.stopPropagation();
      }

      _index__WEBPACK_IMPORTED_MODULE_1__["default"].updateDate.addEventListener('change', (event) => {
        updateDueDate(event);
      });
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].updatePriority.addEventListener('change', updatePriorityVal);
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].updateDesc.addEventListener('input', updateDescription);
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.addEventListener('click', closeTaskUpdateMenuOnBgClick);
    }
  }

  function updatePriorityVal(event) {
    _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr = _tasks__WEBPACK_IMPORTED_MODULE_3__["default"].savedTasksArr();
    const taskName = _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskName.innerText.toLowerCase();
    const projectName = _index__WEBPACK_IMPORTED_MODULE_1__["default"].projectName.innerText.slice(0,
      (_index__WEBPACK_IMPORTED_MODULE_1__["default"].projectName.innerText.indexOf('project')) - 1).toLowerCase();
    for (let i = 0; i <= _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr.length - 1; i += 1) {
      if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskName.innerText.toLowerCase()
        === _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].taskTitle.toLowerCase()
            && (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.includes(projectName)
            || (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.length === 1
            && projectName === 'random'))) {
        const updatedTasks = _index__WEBPACK_IMPORTED_MODULE_1__["default"].tasks();
          ...
          if (updatedTasks[j].getAttribute('data-task') === taskName
            ...
            if (event.target.value === 'High') {
              if (updatedTasks[j].classList.contains('high-priority')) {
                ...
                _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].priority = event.target.value;
                _storage__WEBPACK_IMPORTED_MODULE_4__["tasksFromLS"].updateData(_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr);
                break;
              } else {
  ...
  function closeTaskUpdateMenuOnBgClick() {
    if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display === 'block'
            && (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.style.display !== 'grid'
             || window.getComputedStyle(_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm).display !== 'grid')
            && event.target === _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties
            && event.target !== _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskUpdateForm
            && !(Array.from(_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskUpdateForm.children).includes(event.target))) {
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskUpdateForm.reset();
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskUpdateForm.style.display = 'none';
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskInputForm.style.display = 'grid';
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].taskProperties.style.display = 'none';
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].navContainer.style.removeProperty('opacity');
      _index__WEBPACK_IMPORTED_MODULE_1__["default"].tasksBoard.style.removeProperty('opacity');
        ...
        for (let j = 0; j < updatedTasks.length; j += 1) {
          if (updatedTasks[j].getAttribute('data-task') === taskName
            ...
            if (event.target.value !== '') {
              _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].dueDate = event.target.value;
              timeLeft.innerText = `${Object(date_fns__WEBPACK_IMPORTED_MODULE_0__["formatDistanceToNowStrict"])(new Date(_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].dueDate),
                { addSuffix: true })}`;
              _storage__WEBPACK_IMPORTED_MODULE_4__["tasksFromLS"].updateData(_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr);
              event.stopPropagation();
              break;
  ...
  function updateDescription(event) {
    ...
    for (let i = 0; i <= _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr.length - 1; i += 1) {
      if (_index__WEBPACK_IMPORTED_MODULE_1__["default"].taskName.innerText.toLowerCase()
      === _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].taskTitle.toLowerCase()
                && (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.includes(projectName.toLowerCase())
                    || (_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].projectsRelated.length === 1
                        && projectName === 'random'))) {
        _index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr[i].desc = event.target.value;
        break;
      }
    }
    _storage__WEBPACK_IMPORTED_MODULE_4__["tasksFromLS"].updateData(_index__WEBPACK_IMPORTED_MODULE_1__["default"].savedTasksArr);
...
/* harmony default export */ __webpack_exports__["default"] = (tasksBoardHandlers);
